...
type ConversationStore = {
	...
	fullConversationsVersion: number;
	loading: boolean;
	error: string | null;
...
export const conversationStore = {
	...
	get fullConversations() {
		return store.fullConversations;
	},
	
	get fullConversationsVersion() {
		return store.fullConversationsVersion;
	},
	...
	async loadFullConversation(id: string) {
		...
		try {
			...
			if (conversation) {
				...
				store.fullConversationsVersion++;
				return conversation;
			}
			return null;
		} catch (error) {
